...
export const COMPOSICOES_PROFISSIONAIS: ComposicaoProfissional[] = [
  ...
  { id: 39, categoria: 'REGULARIZACAO_PAREDES_TETOS', profissional: 'Gesseiro', descricao: 'Gesso liso em paredes internas', servico: 'Gesso Liso Paredes', refSINAPI: '87421', medicao: 'M²', unidade: 'M²', producaoMensalSINAPI: 320, valorRefMetaDiaria: 10.80, produtividadeUNh: 1.82, produtividadeUNdia: 14.6, metaProducaoMes: 321, metaProducaoSemana: 74.1 },
  { id: 40, categoria: 'REGULARIZACAO_PAREDES_TETOS', profissional: 'Gesseiro', descricao: 'Gesso liso em tetos', servico: 'Gesso Liso Teto', refSINAPI: '87414', medicao: 'M²', unidade: 'M²', producaoMensalSINAPI: 235, valorRefMetaDiaria: 14.50, produtividadeUNh: 1.33, produtividadeUNdia: 10.6, metaProducaoMes: 233, metaProducaoSemana: 53.9 },
  { id: 41, categoria: 'REGULARIZACAO_PISO', profissional: 'Pedreiro', descricao: 'Execução de contrapiso em argamassa traço 1:3', servico: 'Contrapiso Farofa 2cm', refSINAPI: '87622', medicao: 'M²', unidade: 'M²', producaoMensalSINAPI: 260, valorRefMetaDiaria: 10.00, produtividadeUNh: 2.86, produtividadeUNdia: 22.9, metaProducaoMes: 504, metaProducaoSemana: 116.3 },
]
